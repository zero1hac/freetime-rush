...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        ...
        String textShare = "Hello, I'm a shared content";
    ...
    // Do steps 2 - 4 within the shareText metho
    ...
    public void shareText(String params){
        String mimeType = "text/plain";
        String tittle = "Learning how to Share";
        String textShare = params;

        ShareCompat.IntentBuilder.from(this)
                .setChooserTitle(tittle)
                .setType(mimeType)
                .setText(textShare).startChooser();
    }
}