...
public class MainActivity extends AppCompatActivity {
    ...
    static  final String queryURL = "query";

    // COMPLETED (2) Create a static final key to store the search's raw JSON
    static final String rawJSON = "results";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState!=null){
            ...
            mSearchResultsTextView.setText(savedInstanceState.getString(rawJSON));
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState){
        ...
        String tempGithubQueryURL = mUrlDisplayTextView.getText().toString();

        outState.putString(queryURL, tempGithubQueryURL);
        String rawResults = mSearchResultsTextView.getText().toString();
        outState.putString(rawJSON, rawResults);
